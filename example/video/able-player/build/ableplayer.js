...
(function ($) {
	...
	AblePlayer.prototype.getCookie = function() {
		...
		// var captionsVal = parseInt(urlParams.get('captions'));
		...
		var defaultCookie = {
			preferences: {
				...
				prefCaptionsFont: 'sans',
				prefCaptionsColor: '#ffffff',
				prefCaptionsBGColor: '#000000',
				prefDescFormat: 'video',
				prefDescPause: 0,
				prefVisibleDesc: 1,
				prefSign: singLangVal,
				prefDesc: descriptionVal,
				prefCaptions: captionVal,
